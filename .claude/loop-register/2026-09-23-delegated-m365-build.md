...
- **Kind:** deferred
- **Hop:** 3 · Task 7 docs
- **State:** closed · fixed in the closing hop at the monitor's instruction, in the commit that follows f22cf3b (the same defect in the Outlook CLI fixed with it); plan Status 21:49
