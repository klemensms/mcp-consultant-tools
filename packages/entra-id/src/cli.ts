...
/**
 * @mcp-consultant-tools/entra-id CLI
 *
 * Command-line interface for Microsoft Entra ID app-registration audit.
...
const program = createCliProgram({
  name: 'mcp-entra-cli',
  description: 'Microsoft Entra ID CLI - app registration audit, secret and certificate expiry',
  version: pkg.version,
});
