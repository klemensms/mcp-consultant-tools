...
import { registerLogicAppCommands } from './logic-app-commands.js';
...
export function registerAllCommands(program: Command, ctx: ServiceContext): void {
  ...
  registerLogicAppCommands(program, ctx);
...
export { registerLogicAppCommands } from './logic-app-commands.js';
