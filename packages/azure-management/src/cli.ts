...
/**
 * @mcp-consultant-tools/azure-management CLI
 *
 * Command-line interface for Azure Management operations.
...
const program = createCliProgram({
  name: 'mcp-azure-mgmt-cli',
  description: 'Azure Management CLI - resource discovery and inspection',
  version: pkg.version,
});
