...
/**
 * @mcp-consultant-tools/azure-storage CLI
 *
 * Command-line interface for Azure Storage operations.
...
const program = createCliProgram({
  name: 'mcp-storage-cli',
  description: 'Azure Storage CLI - blobs, files, queues, tables',
  version: pkg.version,
});
