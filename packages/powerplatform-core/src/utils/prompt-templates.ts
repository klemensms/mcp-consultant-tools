...
export const ENTITY_OVERVIEW = (entityName: string) =>
...
export const ATTRIBUTE_DETAILS = (entityName: string, attributeName: string) =>
...
export const QUERY_TEMPLATE = (entityNamePlural: string) =>
...
export const RELATIONSHIP_MAP = (entityName: string) =>
