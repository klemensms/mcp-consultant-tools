 ...
 *
 * EXCEPTION AUTH MODE - Only for production client scenarios requiring user-delegated permissions.
 * For internal development and testing, use Service Principal auth (with client_secret) instead.
 *
 * Flow:
