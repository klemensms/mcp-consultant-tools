...
/**
 * @mcp-consultant-tools/message-center CLI
 *
 * Command-line interface for Microsoft 365 Service Health + Message Center.
...
const program = createCliProgram({
  name: 'mcp-message-center-cli',
  description: 'Microsoft 365 Service Health & Message Center CLI - health overviews, issues, incident reports, and Message Center posts',
  version: pkg.version,
});
