...
/**
 * @mcp-consultant-tools/azure-defender CLI
 *
 * Command-line interface for Microsoft Defender for Cloud.
...
const program = createCliProgram({
  name: 'mcp-defender-cli',
  description: 'Microsoft Defender for Cloud CLI - secure score, assessments, compliance, attack paths',
  version: pkg.version,
});
