...
async function testConversionStrategies() {
  try {
    ...
    const searchResult = await service.searchWikiPages("Release_002", "Acme", 5);
    ...
    try {
      await service.getWikiPage("Acme", result.wikiId, strategy1, false);
      console.log(`  ✓ SUCCESS!`);
    } catch (error) {
      console.log(`  ✗ Failed`);
    }
    ...
    try {
      await service.getWikiPage("Acme", result.wikiId, strategy2, false);
      console.log(`  ✓ SUCCESS!`);
    } catch (error) {
      console.log(`  ✗ Failed`);
    }
    ...
    try {
      await service.getWikiPage("Acme", result.wikiId, strategy3, false);
      console.log(`  ✓ SUCCESS!`);
    } catch (error) {
      console.log(`  ✗ Failed`);
    }
    ...
    try {
      await service.getWikiPage("Acme", result.wikiId, strategy4, false);
      console.log(`  ✓ SUCCESS!`);
    } catch (error) {
      console.log(`  ✗ Failed`);
    }
    ...
    try {
      await service.getWikiPage("Acme", result.wikiId, strategy5, false);
      console.log(`  ✓ SUCCESS!`);
    } catch (error) {
      console.log(`  ✗ Failed`);
    }
