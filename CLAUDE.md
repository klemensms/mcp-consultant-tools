...
1. **MCP Server Layer** ([src/index.ts](src/index.ts))
   ...
   - Registers 116 tools and 23 prompts across PowerPlatform, Azure DevOps, Figma, Application Insights, Log Analytics, and Azure SQL Database integrations
   - Handles environment configuration and lazy-initialization of services (PowerPlatformService, AzureDevOpsService, FigmaService, ApplicationInsightsService, LogAnalyticsService, AzureSqlService)
