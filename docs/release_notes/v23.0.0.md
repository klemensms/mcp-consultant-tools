...
### Service Principal Authentication (Existing)
...
| Package | Version |
|---------|---------|
| @mcp-consultant-tools/powerplatform | 23.0.0 |
| @mcp-consultant-tools/powerplatform-data | 23.0.0 |
| @mcp-consultant-tools/azure-devops | 23.0.0 |
| @mcp-consultant-tools/figma | 23.0.0 |
