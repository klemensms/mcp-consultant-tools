...
- `sql-execute-query` now accepts optional `serverId` and `database` parameters
...
### With Endpoint Discovery (Zero-Discovery Workflow)
  ...
  "mcpServers": {
    "rest-api": {
      ...
      "env": {
        ...
        "OAUTH2_CLIENT_SECRET": "your-client-secret",
        "OAUTH2_SCOPE": "api://your-app-id/.default",
        "REST_ENDPOINTS_JSON": "{\"endpoints\":[{\"path\":\"/contacts\",\"methods\":[\"GET\",\"POST\"],\"entityName\":\"contact\"},{\"path\":\"/sic_exams\",\"methods\":[\"GET\",\"POST\",\"PUT\",\"DELETE\"],\"entityName\":\"sic_exam\"}],\"schemas\":{\"sic_exam\":{\"entityName\":\"sic_exam\",\"pluralName\":\"sic_exams\",\"endpoint\":\"/sic_exams\",\"primaryKey\":\"sic_examid\",\"fields\":[{\"name\":\"sic_examid\",\"type\":\"Guid\",\"required\":false,\"nullable\":false},{\"name\":\"sic_name\",\"type\":\"string\",\"required\":true,\"nullable\":false,\"maxLength\":200}]}}}"
      }
    }
  }
}
...
- [ ] **Endpoint discovery**: Test `rest-list-endpoints` tool
  - Configure `REST_ENDPOINTS_JSON` with sample endpoints
  - Run `rest-list-endpoints` to list all endpoints
  - Run `rest-list-endpoints` with filter parameter
- [ ] **Schema lookup**: Test `rest-get-schema` tool
  - Configure schemas in `REST_ENDPOINTS_JSON`
  - Run `rest-get-schema` with entity name
  - Verify schema fields are returned correctly
...
| `REST_ENDPOINTS_JSON` | Endpoint definitions | See examples above |
...
- `REST_ENDPOINTS_JSON` - Enable endpoint discovery without changes to existing setup
