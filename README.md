...
| **azure-defender** | Microsoft Defender for Cloud (secure score, assessments, compliance, attack paths, security alerts, plan configuration) | 15 | `mcp-defender-cli` | [Setup & Usage](docs/documentation/AZURE_DEFENDER.md) |
...
| **teams** | Microsoft Teams messaging & reading | 26 | `mcp-teams-cli` | [Setup & Usage](docs/documentation/TEAMS.md) |
